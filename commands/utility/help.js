...
const Emotes = {
    admin: ":ghost: Admin - (15)",

    info: ":ghost: Info - (12)",
    mod: ":ghost: Mod - (22)",
    utility: ":ghost: Utility - (8)"
};
...
const Embed = new Discord.MessageEmbed()
    ...
    .setDescription(Description + AllCommands.join("") + "" + "\n\n" + "**Links -**" + ` [Join Support](https://discord.gg/delimine) • [Invite Me](https://discordapp.com/oauth2/authorize?client_id=${bot.user.id}&permissions=8&scope=bot)`)
